...
- [moby/moby](https://github.com/moby/moby) ([v25.0.3](https://github.com/moby/moby/releases/tag/v25.0.3), 3 days ago) - The Moby Project - a collaborative project for the container ecosystem to assemble container-based systems
- [tonistiigi/xx](https://github.com/tonistiigi/xx) ([v1.4.0](https://github.com/tonistiigi/xx/releases/tag/v1.4.0), 4 days ago) - Dockerfile cross-compilation helpers
- [crazy-max/docker-docker](https://github.com/crazy-max/docker-docker) ([25.0.2-r0](https://github.com/crazy-max/docker-docker/releases/tag/25.0.2-r0), 4 days ago) - Docker in Docker (DinD) image
