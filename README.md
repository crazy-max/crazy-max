...
- [docker/buildx](https://github.com/docker/buildx) ([v0.11.0-rc1](https://github.com/docker/buildx/releases/tag/v0.11.0-rc1), 2 days ago) - Docker CLI plugin for extended build capabilities with BuildKit
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.1.12](https://github.com/squidfunk/mkdocs-material/releases/tag/9.1.12), 2 days ago) - Documentation that simply works
- [distribution/distribution](https://github.com/distribution/distribution) ([v2.8.2](https://github.com/distribution/distribution/releases/tag/v2.8.2), 3 days ago) - The toolkit to pack, ship, store, and deliver container content
