...
- [actions/virtual-environments](https://github.com/actions/virtual-environments) ([win19/20210202.1](https://github.com/actions/virtual-environments/releases/tag/win19%2F20210202.1), 2 days ago) - GitHub Actions virtual environments
- [AdguardTeam/AdGuardHome](https://github.com/AdguardTeam/AdGuardHome) ([v0.105.0-beta.3](https://github.com/AdguardTeam/AdGuardHome/releases/tag/v0.105.0-beta.3), 3 days ago) - Network-wide ads &amp; trackers blocking DNS server
- [librenms/docker](https://github.com/librenms/docker) ([21.1.0-r0](https://github.com/librenms/docker/releases/tag/21.1.0-r0), 3 days ago) - LibreNMS Docker image based on Alpine Linux and Nginx
- [crazy-max/docker-docker](https://github.com/crazy-max/docker-docker) ([20.10.3-r0](https://github.com/crazy-max/docker-docker/releases/tag/20.10.3-r0), 3 days ago) - Docker in Docker (DinD) image
- [librenms/librenms](https://github.com/librenms/librenms) ([21.1.0](https://github.com/librenms/librenms/releases/tag/21.1.0), 3 days ago) - Community-based GPL-licensed network monitoring system
