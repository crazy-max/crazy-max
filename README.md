...
- [crazy-max/goxx](https://github.com/crazy-max/goxx) ([v0.27.0](https://github.com/crazy-max/goxx/releases/tag/v0.27.0), 2 days ago) - Go CGO cross-compiler Docker image
- [moby/buildkit](https://github.com/moby/buildkit) ([v0.13.0-rc1](https://github.com/moby/buildkit/releases/tag/v0.13.0-rc1), 2 days ago) - concurrent, cache-efficient, and Dockerfile-agnostic builder toolkit
- [docker/compose](https://github.com/docker/compose) ([v2.24.6](https://github.com/docker/compose/releases/tag/v2.24.6), 3 days ago) - Define and run multi-container applications with Docker
