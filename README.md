...
- [crazy-max/ghaction-setup-containerd](https://github.com/crazy-max/ghaction-setup-containerd) - GitHub Action to set up containerd (4 days ago)
- [moby/buildkit-bench](https://github.com/moby/buildkit-bench) -  (4 days ago)
...
- [moby/moby](https://github.com/moby/moby) ([v27.2.0](https://github.com/moby/moby/releases/tag/v27.2.0), 6 days ago) - The Moby Project - a collaborative project for the container ecosystem to assemble container-based systems
