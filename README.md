...
- [unum-cloud/ucall](https://github.com/unum-cloud/ucall) ([v0.5.2](https://github.com/unum-cloud/ucall/releases/tag/v0.5.2), 2 days ago) - Remote Procedure Calls  - 50x lower latency and 70x higher bandwidth than FastAPI, implementing JSON-RPC &amp; 🔜 REST over io_uring and SIMDJSON ☎️
- [moby/moby](https://github.com/moby/moby) ([v24.0.8](https://github.com/moby/moby/releases/tag/v24.0.8), 4 days ago) - The Moby Project - a collaborative project for the container ecosystem to assemble container-based systems
...
- [docker/compose](https://github.com/docker/compose) ([v2.24.3](https://github.com/docker/compose/releases/tag/v2.24.3), 5 days ago) - Define and run multi-container applications with Docker

#### ❤️ Latest sponsors
- [Mikal](https://github.com/Ifiht) (4 weeks ago)
