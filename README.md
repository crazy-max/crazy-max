...
- [docker/compose-cli](https://github.com/docker/compose-cli) ([v1.0.34](https://github.com/docker/compose-cli/releases/tag/v1.0.34), 1 day ago) - Easily run your Compose application to the cloud with compose-cli
- [squidfunk/mkdocs-material](https://github.com/squidfunk/mkdocs-material) ([9.1.15](https://github.com/squidfunk/mkdocs-material/releases/tag/9.1.15), 5 days ago) - Documentation that simply works
